...
namespace application
{
    Logic::Logic(application::HardwareFactory& hardware)
        ...
        , terminalWithStorage{ hardware.Terminal(), hardware.Tracer(), services::TerminalWithBanner::Banner{ "sync_foc_sensored:torque", hardware.PowerSupplyVoltage(), hardware.SystemClock() } }
        , motorStateMachine(
